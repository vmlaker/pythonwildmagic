# -*- coding: utf-8 -*-
#
# Python Wild Magic documentation build configuration file, created by
# sphinx-quickstart on Thu Jun  7 09:10:45 2012.
#
...
project = u'Python Wild Magic'
copyright = u'2012, Velimir Mlaker'
...
htmlhelp_basename = 'PythonWildMagicdoc'
...
latex_documents = [
  ('index', 'PythonWildMagic.tex', u'Python Wild Magic Documentation',
...
man_pages = [
    ('index', 'pythonwildmagic', u'Python Wild Magic Documentation',
     [u'Velimir Mlaker'], 1)
]
